...
import { MenuItemSidebar } from 'src/app/core/interfaces/sidebar/menu-sidebar.model';
import { MENU_SIDEBAR_TEMP } from 'src/app/core/constants-temp/menu-sidebar';
...
export class SidebarComponent implements OnInit {
  ...
  menuItemsSidebar: MenuItemSidebar[] = [];
  
  public urlApp: string = this.generalModel.urlApp || "";
  
  constructor(private authLoginService: AuthLoginService, private generalModel: GeneralModel, @Inject(DOCUMENT) private document: Document, private renderer: Renderer2, router: Router) { 
  ...
  ngOnInit(): void {
    this.menuItemsSidebar = MENU_SIDEBAR_TEMP;
    /**
